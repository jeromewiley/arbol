<?php
############ Configuration ##############
$thumb_square_size 		= 32; //Thumbnails will be cropped to 200x200 pixels
$max_image_size 		= 500; //Maximum image size (height and width)
$thumb_prefix			= "thumb_"; //Normal thumb Prefix
$destination_folder		= 'images/upload/'; //upload directory ends with / (slash)
